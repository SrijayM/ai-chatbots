...
export const CompanionForm = ({
  ...
  return(
    <div className="h-full p-4 space-y-2 max-w-3xl mx-auto">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 pb-19">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField name="name" control={form.control} render={({field})=>(
              <FormItem className="col-span-2 md:col-span-1">
                ...
                <FormControl>
                  <Input disabled={isLoading} placeholder="Tom Brady" {...field}/>
                </FormControl>
                <FormDescription>
            ...
            <FormField name="description" control={form.control} render={({field})=>(
              <FormItem className="col-span-2 md:col-span-1">
                ...
                <FormControl>
                  <Input disabled={isLoading} placeholder="Former NFL Quarterback" {...field}/>
                </FormControl>
                <FormDescription>
          ...
          <div className="space-y-2 w-full">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Detailed instructions for chatbot Behaviour.
              </p>
            </div>
            <Separator className="bg-primary/10"/>
          </div>
          <FormField name="instructions" control={form.control} render={({field})=>(
              <FormItem className="col-span-2 md:col-span-1">
                ...
                <FormControl>
                  <Textarea className="bg-background resize-none" rows={8
